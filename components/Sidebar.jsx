    ...
    >
      <div>
        ...
        <div className={`flex ${expand ? 'flex-row gap-10' : 'flex-col items-center gap-8'}`}>
          {/* Use your JPG brand mark; no more logo_text */}
          {expand ? (
            <img
              src="/next.jpg"
            ...
            <img src="/next.jpg" alt="PromptPilot" className="h-10 w-10 rounded-md" />
          )}
          ...
          >
            <Image src={assets.menu_icon} alt="menu" className="md:hidden" width={20} height={20} />
            <Image
      ...
      <div>
        ...
        >
          ...
          <div className={`absolute -top-60 pb-8 ${!expand && '-right-40'} opacity-0 group-hover:opacity-100 hidden group-hover:block transition`}>
            <div className="relative w-max bg-black text-white text-sm p-3 rounded-lg shadow-lg">
              ...
              <p>Scan to get PromptPilot App</p>
              <div
                className={`w-3 h-3 absolute bg-black rotate-45 ${
          ...
          {expand && (
            <>
              <span>Get App</span>
              <Image alt="new" src={assets.new_icon} width={16} height={16} />
            </>
          )}
        </div>
        ...
        >
          {user ? (
            ...
            <Image src={assets.profile_icon} alt="profile" className="w-7" width={28} height={28} />
          )}
